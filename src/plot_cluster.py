...
def plot_spectrum(identifier,precursor_mz,precursor_charge, mz,intensity,peptide):
...
def main(mzml_file,cluster_file,scan):
    ...
    for n, spec in enumerate(run):
        if spec.ID in scans:
            ...
            plot_spectrum(spec.ID,precursors[0]["mz"],precursors[0]["charge"], spec.mz,spec.i,"SLEGSSDTALPLRR")
...
if __name__ == "__main__":
    ...
    scan = sys.argv[3]
    main(mzml_file,cluster_file,scan)
