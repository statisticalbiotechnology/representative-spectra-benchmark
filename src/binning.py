...
class RepresentativeSpectrumCreator:
    ...
    def bin_spectra(self, peaklists, minimum=100, maximum=2000, binsize=0.02, peak_quorum=0.25):
        """
        ...
        merged_spectrum['intensities'][merged_spectrum['n_peaks'] < peak_quorum_int] = np.nan
...
def main():
    ...
    for cluster_id, peaklists in clusters.items():
        rsc_spectrum = rsc.bin_spectra(peaklists, minimum=100, maximum=2000, binsize=0.02)
